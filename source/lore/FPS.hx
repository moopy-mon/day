...
class FPS extends TextField
{
	...
	**/
	...
	public function updateFromPrefs():Void {
		...
		var loreThing:String = "Moopy Monday v";
		...
		if (ClientPrefs.showLore) { templateText += '${loreThing}${(MainMenuState.moopVer.endsWith(".0") ? MainMenuState.moopVer.replace(".0", "") : MainMenuState.moopVer) + MainMenuState.versionSuffix}'; }
